...
- (void)presentDialogViewController:(id)arg1 options:(id)arg2 { 
        ...
        %log;
        NSLog(@"fuckYoCouch.xm: <PBWindowManager %@> presentDialogViewController: %@ options: %@ ", self, arg1, arg2);
...
-(void)presentDialogWithContext:(id)arg1 options:(id)arg2 completion:(id)arg3 { 
        ...
        %log;
        NSLog(@"fuckYoCouch.xm: <PBDialogManager %@> presentDialogWithContext: %@ options: %@ completion: %@ ", self, arg1, arg2, arg3);
        //Check to see if anything is now playing
        MRMediaRemoteGetNowPlayingInfo(dispatch_get_main_queue(), ^(CFDictionaryRef info) {
        //NSLog(@"We got the information: %@", info);
